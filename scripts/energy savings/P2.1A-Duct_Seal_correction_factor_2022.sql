...
--modification 5/26/2026, added AMsrUseWBkWh and AMsrUseWBtherm, applied 1/3 factor to AMsrUseWBkWh,AMsrUseWBther,APreUseWBkWh,APreUseWBtherm
...
("APreUseWBkWh" * (0.333)) as "APreUseWBkWh",
("APreUseWBtherm"* (0.333)) as "APreUseWBtherm",
"AStdUseWBkWh",
"AStdUseWBtherm",
("AMsrUseWBkWh" * (0.333)) as "AMsrUseWBkWh",
("AMsrUseWBtherm" * (0.333)) as "AMsrUseWBTherm",
"APreUseEUkWh",
"APreUseEUtherm",
"AStdUseEUkWh",
"AStdUseEUtherm",
