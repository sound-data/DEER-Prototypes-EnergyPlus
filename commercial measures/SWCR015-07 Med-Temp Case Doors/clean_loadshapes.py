...
if __name__ == '__main__':
    ...
    input_zips = [
        'CEDARS_LoadShape_Com - Bldg1.zip', 
        'CEDARS_LoadShape_Com - Bldg2.zip',
        'CEDARS_LoadShape_Com - Bldg3.zip'
    ]
    ...
    "BldgHVAC" AS "BldgHVAC",
    "BldgLoc" AS "BldgLoc",
    'Cap-Tons' AS "NormUnit",
    "Type" AS "Type (Whole Building or End Use)",
    ...
    for input_zip in input_zips:
        if os.path.exists(input_zip):
            clean_loadshapes_zip(input_zip)
        else:
