# Normalizing units for measure

The measure's normalizing unit is cooling capacity (detail in eTRM).
EnergyPlus does not autosize nor output design refrigeration compressor
capacity. However, the maximum capacity available from compressors can be
