...
df_master = pd.read_excel('DEER_EnergyPlus_Modelkit_Measure_list_SWCR021.xlsx', sheet_name='Measure_list', skiprows=4)
...
measure_name = 'SWCR021-05 Display Case wDoors'
...
filepath = f'commercial measures/SWCR021-05 Display Case wDoors' #only changed this for testing
