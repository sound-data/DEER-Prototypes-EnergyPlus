...
#filename_sizing_agg = 'results-sizing-agg-HW Boiler-New.csv'
#filename_simannual = 'sim_annual_MFM_HW_New.csv'
#filename_simannual = 'sfm_annual.csv'

filename_sizing_agg = 'results-sizing-agg-HW Boiler-Ex.csv'
filename_simannual = 'sim_annual_MFM_HW_Ex.csv'

# Specify the files to output from this script
output_sizing = 'results-per-dwelling.csv'
output_simannual = 'sim_annual_withunits.csv'

# Specify the column name to use for normalizing units.
sizing_column = 'Boiler:HotWater Design Size Nominal Capacity (W)'
#sizing_column = 'Boiler:Steam Design Size Nominal Capacity (W)'
...
df_measure = df_master[df_master['Measure (general name)'] == 'HW Boiler Sapce Heating']
#df_measure = df_master[df_master['Measure (general name)'] == 'Steam Boiler Sapce Heating']
